...
class SolutionController extends Controller
{
    ...
    private function validated(Request $request): array
    {
        return $request->validate([
            ...
            'translations.*.architecture_approach' => ['array'],
            'translations.*.architecture_approach.*.title' => ['nullable', 'string', 'max:255'],
            'translations.*.architecture_approach.*.description' => ['nullable', 'string'],
            'translations.*.use_cases' => ['array'],
            'translations.*.use_cases.*.audience' => ['nullable', 'string', 'max:255'],
            'translations.*.use_cases.*.description' => ['nullable', 'string'],
            'translations.*.trust_safety' => ['array'],
            'translations.*.trust_safety.*.question' => ['nullable', 'string', 'max:255'],
            'translations.*.trust_safety.*.answer' => ['nullable', 'string'],
        ...
        foreach ($translations as $locale => $payload) {
            ...
            $solution->translations()->updateOrCreate(
                ...
                [
                    ...
                    'architecture_approach' => $payload['architecture_approach'] ?? [],
                    'use_cases' => $payload['use_cases'] ?? [],
                    'trust_safety' => $payload['trust_safety'] ?? [],
